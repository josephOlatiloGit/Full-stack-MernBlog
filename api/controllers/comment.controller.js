...
/**
 * Post Likes function:
 * We check if the userId is absent(-1) in the like Index we push it else we splice it from the array.
 */
...
// Get All Comments DashComment page:
...
export const getComments = async (req, res, next) => {
  ...
  try {
    ...
    // To get the total comments and from one month ago:
